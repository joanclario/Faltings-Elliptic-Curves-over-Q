...
## Tables Obtained from `L_3(9).nb`

The notebook `L_3(9).nb` also contains the computations needed to obtain Tables 8, 9, and 10 of the article. These computations are organized into sections according to the prime $p$ under consideration:
