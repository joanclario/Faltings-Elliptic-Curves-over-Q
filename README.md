...
This file Faltings_Magma.zip contains the Magma scripts used to carry out the computations described in the article. The code reproduces the computational results and examples discussed throughout the paper.
